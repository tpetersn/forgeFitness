...
.btn-col { display: flex; flex-direction: column; gap: 0.5rem; padding: 0 1rem; }
.ghost  {
  display:block; text-align:center; padding: 0.5rem 0;
  background:#68707d; color:#fff; text-decoration:none; border-radius:4px;
}

.item-list { flex:1; overflow:auto; padding:0.5rem 1rem; list-style:none; }
.item-list li { display:flex; justify-content:space-between; margin-bottom:0.5rem; }

.total {
  display:flex; justify-content:space-between;
  padding: 0.75rem 1rem; font-weight:700; border-top:1px solid #ccc;
}

.checkout {
  margin: 0.75rem 1rem 1rem;
  display:block; text-align:center; padding:0.6rem 0;
